...
@Composable
fun NewEntryScreen() {
    var (mood, setMood) = remember { mutableStateOf(3) }
    var (anxiety, setAnxiety) = remember { mutableStateOf(3) }
    Column(
        ...
        Column(
            ...
            Row(
                ...
                Card (
                    ...
                    modifier = Modifier
                        .background(
                            Color(android.graphics.Color.parseColor(valueColors[value - 1])).copy(alpha = 0.1f),
                            shape = MaterialTheme.shapes.small)
                        .padding(12.dp)

                ){
                    Icon(if(value > 3) Icons.Default.SentimentVerySatisfied
